...
\begin{frame}[plain] % plain removes header/footer
  ...
  \includegraphics[page=1,scale=0.9]{aux/devereux_hart_2010_f8.pdf}
\end{frame}

\begin{frame}[plain] % plain removes header/footer
  \frametitle{Devereaux and Hart 2010}
  \includegraphics[page=1,scale=0.9]{aux/devereux_hart_2010_f7.pdf}
\end{frame}

\begin{frame}[plain] % plain removes header/footer
  \frametitle{Grenet 2013}
  \includegraphics[page=1,scale=0.9]{aux/grenet_2013_t3.pdf}
\end{frame}
...
\frame{\frametitle{Zimmerman (2014): The Florida Setting}
\begin{itemize}
\begin{small}
\item Florida State University System (SUS): 11 public 4-year campuses
\vspace{0.05in}
\item Standard admission: HS GPA above a sliding-scale cutoff (decreasing in SAT)
\vspace{0.05in}
\item Focus campus: Florida International University (FIU), Miami
\vspace{0.05in}
\item GPA formulas differ across campuses; FIU the most generous $\to$ ``campus of last resort''
\vspace{0.05in}
\item Below FIU's cutoff $\Rightarrow$ admitted to no SUS campus (Table 1)
\vspace{0.05in}
\item Data (Florida Dept.\ of Education): 6 cohorts of public HS seniors, 15 counties (incl.\ Miami-Dade \& Broward), graduating 1996--2002
\begin{itemize}
\begin{small}
\item HS / community-college / university transcripts \& degrees; SUS application records; senior surveys on college plans
\item Earnings from Florida Unemployment Insurance records, up to 14 years after HS ($\approx$ age 32)
\end{small}
\end{itemize}
\end{small}
\end{itemize}
...
\begin{frame}
\centering
\includegraphics[scale=0.4]{aux/jesse.jpg}
\end{frame}
